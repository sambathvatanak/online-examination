<?php
	...
	include_once ($filepath.'/../classes/Excel_Exam.php');
...
<?php
	if($_SERVER['REQUEST_METHOD'] == "POST"){
	   $UpQue = $exm_excel->updateQuestion($quesNo,$_POST);
}
...
<?php
$getQues = $exm_excel->getQues($quesNo);
...
<?php
$getAns = $exm_excel->getAns($quesNo);
  while ($result = $getAns->fetch_assoc()){
   ...
   $rightAns = $exm_excel->getRightAns($quesNo);
