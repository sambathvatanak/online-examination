...
class myPDF extends FPDF{
    ...
    function viewTable(){
      ...
      //  $stmt = $db->query('SELECT result_id,name,word_score,excel_score,power_score,total_score,grade FROM tbl_result');
        $query = "SELECT result_id,name,word_score,excel_score,power_score,total_score,grade FROM tbl_result WHERE result_id = '$result_id'";
        ...
        while($data = $result->fetch_assoc()) {
            ...
            $this->Cell(30,10,$data['grade'],1,0,'C');
            $this->Ln();
        // }
        //draw line
      //  $this->Ln(15);
