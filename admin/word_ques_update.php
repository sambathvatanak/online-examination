...
<?php
	if($_SERVER['REQUEST_METHOD'] == "POST"){
	   $UpQue = $exm_word->updateQuestion($quesNo,$_POST);
}
...
<div class="main">
  <h3>Admin Panel - Add Word Question</h3>
  <div class="starttest">
			<div class="menu">
		<ul>
...
<?php
$getQues = $exm_word->getQues($quesNo);
...
$getAns = $exm_word->getAns($quesNo);
  while ($result = $getAns->fetch_assoc()){
   ...
   $rightAns = $exm_word->getRightAns($quesNo);
