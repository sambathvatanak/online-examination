	...
	<form action="" method="post">
      ...
      <tr>
			...
			<tr>
				<td>Choice 1</td>
				<td>:</td>
				<td><input type="text"  name="ans1" placeholder="Enter Choice..." required></td>
			</tr>

			<tr>
				<td>Choice 2</td>
				<td>:</td>
				<td><input type="text"  name="ans2" placeholder="Enter Choice..." required></td>
			</tr>

			<tr>
				<td>Choice 3</td>
				<td>:</td>
				<td><input type="text"  name="ans3" placeholder="Enter Choice..." required></td>
			</tr>

			<tr>
				<td>Choice 4</td>
				<td>:</td>
				<td><input type="text"  name="ans4" placeholder="Enter Choice..." required></td>
			</tr>
