...
Session::checkSession();
		...
		if (isset($_GET['q'])) {
			...
			header("Location:Excel_Exam.php");
		}

$total = $exm_excel->getTotalRows();
$question = $exm_excel->getQuesByNumber($number);
?>

<?php

	if($_SERVER['REQUEST_METHOD'] == 'POST') {
		$process = $pro_excel->processData($_POST);
	}

 ?>

<div class="main">
<h3>Excel Question <?php echo $question['quesNo']; ?> of <?php echo $total; ?></h3>
	<div class="test">
